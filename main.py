...
class Bot(BaseBot):
    ...
    async def on_start(self, session_metadata: SessionMetadata) -> None:
        ...
        self.highrise.tg.create_task(self.highrise.teleport(
            session_metadata.user_id, Position(8.50,1.00,1.50, "Rightleft")))
...
if __name__ == "__main__":
    room_id = "65c91b37adb868b40325bd0c"
    token = "8db6437c1dcd115eb4b5c80efa7aa60ec9a95eacef2a1755453398bd8f2bd778"
